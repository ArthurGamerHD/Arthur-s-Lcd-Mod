...
namespace LcdMod.Client.ScreenAreas
{
    ...
    public static class MinimalMwmReader
    {
        ...
        static void TryReadTexCoordsTag(BinaryReader reader,
            int offset,
            float patternScale,
            Vector2 offsetUv,
            out Vector2[] uvs)
        ...
        static void TryReadLodsTag(BinaryReader reader, int offset, List<MinimalMwmLod> lods)
        {
        ...
        static void TryReadPatternScaleTag(BinaryReader reader, int offset, out float patternScale)
        {
            patternScale = 1f;
        ...
        static void ReadMeshPartsTag(BinaryReader reader,
            int offset,
            int version,
            Vector3[] vertices,
            Vector2[] uvs,
