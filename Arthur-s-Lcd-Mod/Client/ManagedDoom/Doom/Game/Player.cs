...
namespace ManagedDoom
{
    public sealed class Player
    {
        ...
        {
            get { return extraLight; }
            set { extraLight = value; }
        }

        public int FixedColorMap
        {
            get { return fixedColorMap; }
